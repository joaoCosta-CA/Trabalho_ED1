 ...
 * @param x1, é um valor inteiro que indica a posição horizontal do primeiro ponto da linha
 * @param y1, é um valor inteiro que indica a posição vertical do primeiro ponto da linha
 * @param x2, é um valor inteiro que indica a posição horizontal do segundo ponto da linha
 * @param y2, é um valor inteiro que indica a posição vertical do segundo ponto da linha
